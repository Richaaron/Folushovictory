...
async function run() {
  ...
  if (st) {
    console.log(`Student fvs-2026-0055: ${st.firstName} ${st.lastName}`);
    console.log(`Religious Studies score object:`, JSON.stringify(st.scores["SYo7gWINpG0hHj2lIWv1"], null, 2));
  } else {
    console.log("Student fvs-2026-0055 not found in broadsheet!");
  }
}
