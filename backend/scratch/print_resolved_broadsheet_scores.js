...
async function run() {
  ...
  console.log("Subjects in broadsheet response order:");
  subjects.forEach(sub => {
    const score = st.scores[sub.id];
    console.log(`  Subject: ${sub.name} [ID: ${sub.id}] | ca1: ${score.ca1} | ca2: ${score.ca2} | exam: ${score.exam} | total: ${score.total} | pos: ${score.subjectPosition}`);
  });
}
