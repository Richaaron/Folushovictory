...
<template>
  <div class="space-y-3">
    ...
    <!-- Subject grid -->
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-2 max-h-56 overflow-y-auto custom-modal-scrollbar pr-1.5 rounded-xl bg-slate-900/40 border border-slate-700/50 p-3">
